...
namespace MineDemo.World
{
    public class WorldManager : MonoBehaviour
    {
        ...
        void UpdateChunks()
        {
            ...
            for (int x = -viewDistance; x <= viewDistance; x++)
            {
                for (int z = -viewDistance; z <= viewDistance; z++)
                {
                    ...
                    if (!activeChunks.ContainsKey(chunkPos) && !chunksToGenerate.Contains(chunkPos))
                    {
        ...
        IEnumerator GenerateChunksCoroutine()
        {
            ...
            {
                // Ưu tiên Rebuild Mesh cho các chunk cũ để xoá mặt ranh giới
                ...
                foreach (var n in neighbors)
                {
                    ...
                    {
                        if (!chunksToUpdateMesh.Contains(neighborChunk))
        ...
        private void QueueChunkIfActive(int cX, int cZ)
        {
            ...
            if (activeChunks.TryGetValue(pos, out Chunk chunk) && !chunksToUpdateMesh.Contains(chunk))
            {
